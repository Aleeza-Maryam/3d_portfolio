...
>
  ...
  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
    {[
      ...
      <div
        key={skill.name}
        className="glass rounded-xl p-4 text-center glow-border hover:scale-105 transition-transform cursor-default group card-3d"
      >
        <div
...
>
  ...
  <div className="flex flex-wrap gap-6 justify-center max-w-3xl mx-auto">
    {[
      ...
      <div
        key={lang.language}
        className="glass rounded-2xl p-6 glow-border hover:shadow-xl transition-all group card-3d flex-1 min-w-[200px] text-center"
      >
